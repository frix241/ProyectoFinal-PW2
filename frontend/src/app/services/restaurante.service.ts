...
export class RestauranteService {
  private apiUrl = "https://proyectofinal-pw2.onrender.com/api";
  ...
  getEntradaById(id: number): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/entradas/${id}/`, {
      headers: this.getHeaders(),
    });
  }
  ...
  actualizarEntrada(id: number, formData: FormData): Observable<any> {
    ...
    return this.http.put(`${this.apiUrl}/entradas/${id}/`, formData, {
      headers,
    });
  }
  eliminarEntrada(id: number): Observable<any> {
    return this.http.delete<any>(`${this.apiUrl}/entradas/${id}/`, {
      headers: this.getHeaders(),
    });
  }
  ...
  getSegundoById(id: number): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/segundos/${id}/`, {
      headers: this.getHeaders(),
    });
  }
  ...
  actualizarSegundo(id: number, segundo: any): Observable<any> {
    return this.http.put<any>(`${this.apiUrl}/segundos/${id}/`, segundo, {
      headers: this.getHeaders(),
    });
  }

  eliminarSegundo(id: number): Observable<any> {
    return this.http.delete<any>(`${this.apiUrl}/segundos/${id}/`, {
      headers: this.getHeaders(),
    });
  }
  ...
  createSegundo(segundo: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/segundos/`, segundo, {
      headers: this.getHeaders(),
    });
  }
